...
struct Device : public Node {
    ...
    struct Capability : public Node {
        ...
        struct Hardware : public StringNode {
            ...
            [[nodiscard]] Optional<String> version() const noexcept { return String{node->first_node("version")}; }
            [[nodiscard]] Optional<String> serial() const noexcept { return String{node->first_node("serial")}; }
            [[nodiscard]] Uuid uuid() const noexcept { return Uuid{node->first_node("uuid")}; }
        };
        ...
        [[nodiscard]] Type type() const noexcept { return *magic_enum::enum_cast<Type>(node->first_attribute("type")->value()); }
        [[nodiscard]] Optional<Integral> class_() const noexcept { return Integral{node->first_node("class")}; }
    ...
    [[nodiscard]] Optional<String> path() const noexcept { return String{node->first_node("path")}; }
    [[nodiscard]] Optional<DevNode> dev_node() const noexcept { return DevNode{node->first_node("devnode")}; }
    [[nodiscard]] Optional<Parent> parent() const noexcept { return Parent{node->first_node("parent")}; }
    [[nodiscard]] Optional<Capability> capability() const noexcept { return Capability{node->first_node("capability")}; }
    [[nodiscard]] Optional<String> product() const noexcept { return String{node->first_node("product")}; }
}; // namespace
} // namespace
}